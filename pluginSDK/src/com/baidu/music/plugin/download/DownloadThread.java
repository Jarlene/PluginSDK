...
public class DownloadThread extends Thread {
    ...
    public DownloadThread(FileDownloader downloader, URL downUrl, File saveFile, long block,
            int downloadedLength, int threadId) {
    ...
    public void run() {
        if (downloadedLength < block) {
            try {
                ...
                long startPos = block * (threadId - 1) + downloadedLength;
