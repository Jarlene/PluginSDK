 ...
 */
public class PluginActivity extends Activity implements ActivityInterface {
    ...
    public void onAttach(Activity proxyActivity, PluginContext pluginContext, Messenger messenger) {
        ...
        mPluginContext = pluginContext; //new PluginContext(proxyActivity, 0, pluginPackage.path,
                // pluginPackage.classLoader);
